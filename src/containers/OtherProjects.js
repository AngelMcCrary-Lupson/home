            ...
            <Row className="Projects">
              ...
              <Col xs={3}>
                <div className="ProjBox">
                  ...
                  <a href="https://github.com/AngelMcCrary-Lupson/husky-study-center" target="_blank">
                    <img className="exlink" src={exlink}/></a>
                </div>
              </Col>
              <Col xs={3}>
                <div className="ProjBox">
                  ...
                  <a href="https://github.com/AngelMcCrary-Lupson/video-playback-extension" target="_blank">
                    <img className="exlink" src={exlink}/></a>
                </div>
              </Col>
