  ...
  render() {
    return (
      <div className="AboutPage" id="home">
        ...
        <Row>
          <Col xs={8}>
            <p className="Text">I’m a senior Informatics student at the University of Washington
                                and a <span>software developer</span>.
                                </p>
            ...
            <p className="Text">If you're curious about my experience and skills feel free to
                                ...
                                <a href={resume} target="_blank"><span>here</span></a>.</p>
          </Col>
          <Col xs={4}>
